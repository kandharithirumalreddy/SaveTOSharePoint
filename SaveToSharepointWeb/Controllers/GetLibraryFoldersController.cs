...
{
    public class GetLibraryFoldersController : ApiController
    {

        [HttpPost]
        public async Task<IHttpActionResult> Post([FromBody]DocumentLibraryInfo request)
        {
            ...
            return await GetDocumentLibraryFolders(request.Id);
        }

        private async Task<IHttpActionResult> GetDocumentLibraryFolders(string driveId)
        {
